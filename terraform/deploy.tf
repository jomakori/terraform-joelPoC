resource "aws_s3_bucket" "this" {
  bucket        = "jomakori-poc-codepipeline"
  force_destroy = true
}
...
resource "aws_iam_role" "pipeline" {
  name               = "pipeline-jomakori-poc-role"
...
resource "aws_iam_role" "codebuild" {
  name               = "codebuild-jomakori-poc-role"
...
resource "aws_codedeploy_app" "this" {
  ...
  name             = "jomakori-poc-deploy"
}

resource "aws_codedeploy_deployment_group" "this" {
  app_name               = "${aws_codedeploy_app.this.name}"
  deployment_group_name  = "jomakori-poc-deploy-group"
  ...
  stage {
    ...
    action {
      ...
      configuration = {
        ...
        FullRepositoryId = "jomakori/jomakori-poc-rep"
        BranchName       = "main"
        # OAuthToken = "${var.github_token}" #old notations
      }
    }
  }
